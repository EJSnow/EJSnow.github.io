...
export default async function (eleventyConfig) {
  ...
  // I want to link to different sections
  eleventyConfig.setLibrary("md", markdownIt({html: true, linkify: true}).use(markdownItAnchor, {level: [2, 3, 4]}));

  // Fixes date parsing to use the correct time zone (this is horrible)
